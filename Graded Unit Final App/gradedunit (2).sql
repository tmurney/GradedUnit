...
--
-- Host: 127.0.0.1
-- Generation Time: May 15, 2017 at 02:59 PM
...
--
-- Indexes for table `moneyin`
--
ALTER TABLE `moneyin`
  ADD PRIMARY KEY (`TransactionID`);

--
-- Indexes for table `moneyout`
--
ALTER TABLE `moneyout`
  ADD PRIMARY KEY (`TransactionID`);
...
--
-- AUTO_INCREMENT for table `moneyin`
--
ALTER TABLE `moneyin`
  MODIFY `TransactionID` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `moneyout`
--
ALTER TABLE `moneyout`
  MODIFY `TransactionID` int(11) NOT NULL AUTO_INCREMENT;
--
